...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("10.3.28.184"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.100.14"), 12124)}, "/Users/ognen/Documents/Ognen/DBTv2 copy/demo-app.unoproj", GetBundle, new string[] { ""})
{
...
{
return Uno.IO.Bundle.Get("demo-app");
}
}
}
