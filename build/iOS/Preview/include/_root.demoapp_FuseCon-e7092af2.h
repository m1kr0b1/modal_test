...
namespace g{struct demoapp_FuseControlsMapMarker_Latitude_Property;}
...
struct demoapp_FuseControlsMapMarker_Latitude_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Controls::MapMarker*> _obj;

    void ctor_3(::g::Fuse::Controls::MapMarker* obj, ::g::Uno::UX::Selector name);
    static demoapp_FuseControlsMapMarker_Latitude_Property* New1(::g::Fuse::Controls::MapMarker* obj, ::g::Uno::UX::Selector name);
};
// }
