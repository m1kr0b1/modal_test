...
#include <Fuse.Scripting.Native-9ab7f31d.h>
...
// /Users/ognen/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.47.7/$.uno
// ---------------------------------------------------------------------------------------
...
::g::Fuse::Scripting::Array* Context::NewArray(uArray* values)
{
    ...
    ::g::Fuse::Scripting::Array* a = uCast< ::g::Fuse::Scripting::Array*>(uPtr(_newArray)->Call(uArray::Init<uObject*>(::TYPES[9/*object[]*/], 1, uBox<int>(::TYPES[48/*int*/], uPtr(values)->Length()))), ::TYPES[11/*Fuse.Scripting.Array*/]);
...
// {
static void NativeEventEmitterModule__FactoryClosure1_build(uType* type)
{
    ::STRINGS[16] = uString::Const("emit");
    type->SetFields(0,
        ::g::Uno::Func2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type->T(0), uObject_typeof()->Array(), NULL), offsetof(::g::Fuse::Scripting::NativeEventEmitterModule__FactoryClosure1, _argsFactory), 0,
...
uType* NativeEventEmitterModule__FactoryClosure1_typeof()
{
    ...
    options.FieldCount = 2;
    options.GenericCount = 1;
    options.ObjectSize = sizeof(NativeEventEmitterModule__FactoryClosure1);
    options.TypeSize = sizeof(uType);
    type = uClassType::New("Fuse.Scripting.NativeEventEmitterModule.FactoryClosure1`1", options);
    type->fp_build_ = NativeEventEmitterModule__FactoryClosure1_build;
    return type;
}

// public FactoryClosure1(Uno.Func<Fuse.Scripting.Context, T, object[]> argsFactory, T t) :1108
...
{
    __this->_argsFactory = argsFactory;
    __this->_t() = t;
}

// public void Emit(Fuse.Scripting.Context c, Fuse.Scripting.Object o) :1114
...
// public FactoryClosure1 New(Uno.Func<Fuse.Scripting.Context, T, object[]> argsFactory, T t) :1108
...
{
    NativeEventEmitterModule__FactoryClosure1* obj1 = (NativeEventEmitterModule__FactoryClosure1*)uNew(__type);
    NativeEventEmitterModule__FactoryClosure1__ctor__fn(obj1, argsFactory, t);
    return *__retval = obj1, void();
}

// public void Emit(Fuse.Scripting.Context c, Fuse.Scripting.Object o) [instance] :1114
void NativeEventEmitterModule__FactoryClosure1::Emit(::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::Object* o)
{
    uStackFrame __("Fuse.Scripting.NativeEventEmitterModule.FactoryClosure1`1", "Emit(Fuse.Scripting.Context,Fuse.Scripting.Object)");
    uPtr(o)->CallMethod(::STRINGS[16/*"emit"*/], (uArray*)uPtr(_argsFactory)->Invoke(2, c, (void*)_t()));
}
// }
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("/Users/ognen/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.47.7/$.uno");
...
uObject* NativeEvent::RaiseSync(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[29/*"this.Contex...*/], ::STRINGS[30/*"/Users/ogne...*/], 899, uArray::New(::TYPES[9/*object[]*/], 0));
...
{
    ::STRINGS[31] = uString::Const("error");
    ::STRINGS[32] = uString::Const("removeAllListeners");
    ...
    ::TYPES[9] = uObject_typeof()->Array();
    ::TYPES[35] = NativeEventEmitterModule__FactoryClosure1_typeof();
    ::TYPES[36] = ::g::Uno::Tuple_typeof()->MakeMethod(0/*Create<object, Fuse.Scripting.Callback>*/, uObject_typeof(), ::g::Fuse::Scripting::Callback_typeof(), NULL);
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[2] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[37] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Tuple2_typeof()->MakeType(uObject_typeof(), ::TYPES[13/*Fuse.Scripting.Callback*/], NULL), NULL);
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[35/*Fuse.Scripting.NativeEventEmitterModule.FactoryClosure1`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL));
    type->SetInterfaces(
...
// protected void EmitError(string reason) :1020
void NativeEventEmitterModule__EmitError_fn(NativeEventEmitterModule* __this, uString* reason)
{
    __this->EmitError(reason);
}

// protected void EmitFactory<T>(Uno.Func<Fuse.Scripting.Context, T, object[]> argsFactory, T t) :1013
void NativeEventEmitterModule__EmitFactory1_fn(NativeEventEmitterModule* __this, uType* __type, uDelegate* argsFactory, void* t)
{
    uType* __types[] = {
        __type->Precalced(0/*Fuse.Scripting.NativeEventEmitterModule.FactoryClosure1<T>*/),
    };
    uStackFrame __("Fuse.Scripting.NativeEventEmitterModule", "EmitFactory`1(Uno.Func<Fuse.Scripting.Context, T, object[]>,T)");
    NativeEventEmitterModule__FactoryClosure1* ret3;
    __this->Dispatch(uDelegate::New(::TYPES[34/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__FactoryClosure1__Emit_fn, (NativeEventEmitterModule__FactoryClosure1__New1_fn(__types[0], argsFactory, t, &ret3), ret3)), false);
}
...
// protected void EmitError(string reason) [instance] :1020
void NativeEventEmitterModule::EmitError(uString* reason)
{
    ...
    Emit(uArray::Init<uObject*>(::TYPES[9/*object[]*/], 2, ::STRINGS[31/*"error"*/], reason));
}
...
void NativeEventEmitterModule::On(uObject* eventName, uDelegate* listener)
{
...

    {
        ...
        const uFinally<decltype(__finally_fun)> __f(__finally_fun);
        ::g::Uno::Collections::List__Add_fn(uPtr(_listeningCallbacks), (::g::Uno::Tuple__Create1_fn(::TYPES[36/*Uno.Tuple.Create<object, Fuse.Scripting.Callback>*/], eventName, listener, &ret4), ret4));
    }
...
void NativeEventEmitterModule::ResetListenersJS()
{
    ...
    uObject* ret7;
    uDelegate* ret8;
    uPtr(_this)->CallMethod(::STRINGS[32/*"removeAllLi...*/], uArray::New(::TYPES[9/*object[]*/], 0));
    ::g::Uno::Threading::Monitor::Enter(_mutex);

    {
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Tuple2*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_listeningCallbacks), &ret6), ret6); enum1.MoveNext(::TYPES[37/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>.Enumerator*/]); )
        {
            ::g::Uno::Tuple2* l = enum1.Current(::TYPES[37/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>.Enumerator*/]);
...
static void NativeModule_build(uType* type)
{
    ...
    ::STRINGS[25] = uString::Const("exports");
    ::TYPES[38] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof(), NULL);
    ::TYPES[12] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[39] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof(), NULL);
    ::TYPES[24] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(2,
        ::TYPES[38/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/], offsetof(::g::Fuse::Scripting::NativeModule, _members), 0,
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    if (module != NULL)
    {
        ...
        if (obj != NULL)
            ...
            for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Scripting::NativeMember*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->_members), &ret3), ret3); enum1.MoveNext(::TYPES[39/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]); )
            {
                ::g::Fuse::Scripting::NativeMember* m = enum1.Current(::TYPES[39/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]);
                uPtr(m)->Create(obj, c);
            }
    }
}
...
{
    _members = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[38/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/]));
    ctor_();
}
...
{
    ::TYPES[40] = ::g::Fuse::Scripting::FutureFactory_typeof();
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[41] = NativePromise__ContextClosure_typeof();
    ::TYPES[42] = ::g::Uno::Threading::Promise_typeof();
    ::TYPES[43] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[44] = ::g::Fuse::Scripting::FactoryClosure_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(3,
        ...
        ::TYPES[40/*Fuse.Scripting.FutureFactory`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Scripting::NativePromise, _futureFactory), 0,
    ...
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", type, (void*)NativePromise__New1_fn, 0, true, type, 3, ::g::Uno::String_typeof(), ::TYPES[40/*Fuse.Scripting.FutureFactory`1*/]->MakeType(type->T(0), NULL), ::g::Fuse::Scripting::ResultConverter_typeof()->MakeType(type->T(0), type->T(1), NULL)),
...
::g::Uno::Threading::Future1* NativePromise::Factory(uArray* args)
{
    ...
    ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[43/*Uno.Threading.ThreadStart*/], (void*)::g::Fuse::Scripting::FactoryClosure__Run_fn, (::g::Fuse::Scripting::FactoryClosure*)::g::Fuse::Scripting::FactoryClosure::New1(__types[1], _func, args, future)))->Start();
    return future;
}
...
{
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[45] = ::g::Uno::Func_typeof();
    ::TYPES[46] = ::g::Uno::Action1_typeof();
    type->SetPrecalc(
        type->T(1),
        type->T(0),
    ...
    type->SetFields(3,
        ::TYPES[45/*Uno.Func`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Scripting::NativeProperty, _getHandler), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Scripting::NativeProperty, _isReadonly), 0,
        type->T(1), (uintptr_t)0, uFieldFlagsConstrained,
        ::TYPES[46/*Uno.Action`1*/]->MakeType(type->T(1), NULL), offsetof(::g::Fuse::Scripting::NativeProperty, _setHandler), 0,
    ...
    type->Reflection.SetFunctions(3,
        ...
        new uFunction(".ctor", type, (void*)NativeProperty__New2_fn, 0, true, type, 4, ::g::Uno::String_typeof(), ::TYPES[45/*Uno.Func`1*/]->MakeType(type->T(0), NULL), ::TYPES[46/*Uno.Action`1*/]->MakeType(type->T(1), NULL), ::g::Fuse::Scripting::ValueConverter_typeof()->MakeType(type->T(0), type->T(1), NULL)),
...
{
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[47] = ::g::Uno::Short_typeof();
    ::TYPES[48] = ::g::Uno::Int_typeof();
    ::TYPES[49] = ::g::Uno::Long_typeof();
    ::TYPES[50] = ::g::Uno::Float_typeof();
...
{
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[47/*short*/]))
        return uBox<int16_t>(::TYPES[47/*short*/], (int16_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[48/*int*/]))
        return uBox<int>(::TYPES[48/*int*/], (int)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[49/*long*/]))
        return uBox<int64_t>(::TYPES[49/*long*/], (int64_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[50/*float*/]))
        return uBox(::TYPES[50/*float*/], (float)value);
...
uObject* JSCallback__NumberConverter::Convert1(float value, uType* targetType)
{
    ...
    return uBox(::TYPES[50/*float*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert2(int value, uType* targetType)
{
    ...
    return uBox<int>(::TYPES[48/*int*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert3(int64_t value, uType* targetType)
{
    ...
    return uBox<int64_t>(::TYPES[49/*long*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert4(int16_t value, uType* targetType)
{
    ...
    return uBox<int16_t>(::TYPES[47/*short*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert5(uType* targetType, uObject* value)
{
    ...
    if (uIs(value, ::TYPES[47/*short*/]))
        return JSCallback__NumberConverter::Convert4(uUnbox<int16_t>(::TYPES[47/*short*/], value), targetType);

    if (uIs(value, ::TYPES[48/*int*/]))
        return JSCallback__NumberConverter::Convert2(uUnbox<int>(::TYPES[48/*int*/], value), targetType);

    if (uIs(value, ::TYPES[49/*long*/]))
        return JSCallback__NumberConverter::Convert3(uUnbox<int64_t>(::TYPES[49/*long*/], value), targetType);

    if (uIs(value, ::TYPES[50/*float*/]))
        return JSCallback__NumberConverter::Convert1(uUnbox<float>(::TYPES[50/*float*/], value), targetType);
...
void NativeEventEmitterModule__OnClosure::On(::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::Object* o)
{
    ...
    uPtr(o)->CallMethod(::STRINGS[34/*"on"*/], uArray::Init<uObject*>(::TYPES[9/*object[]*/], 2, (uObject*)_eventName, (uDelegate*)_listener));
}
...
static void NativePromise__PromiseClosure_build(uType* type)
{
    ...
    ::TYPES[8] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[46] = ::g::Uno::Action1_typeof();
    ::TYPES[52] = ::TYPES[46/*Uno.Action`1*/]->MakeType(::g::Uno::Exception_typeof(), NULL);
    type->SetPrecalc(
        type->T(1),
...
uObject* NativePromise__PromiseClosure::Run(uArray* args)
{
    ...
    uPtr(_promise)->Then1(uDelegate::New(__types[0], (void*)NativePromise__PromiseClosure__Resolve_fn, this), uDelegate::New(::TYPES[52/*Uno.Action<Uno.Exception>*/], (void*)NativePromise__PromiseClosure__Reject_fn, this));
    return NULL;
}
...
{
    ::STRINGS[35] = uString::Const("require(): accepts exactly one argument, ");
    ::STRINGS[36] = uString::Const(" provided");
    ::STRINGS[37] = uString::Const("require(): argument must be a string");
    ...
    type->SetFields(0,
        ...
        ::TYPES[53/*string*/], (uintptr_t)&::g::Fuse::Scripting::ScriptModule__RequireContext::_lastErrorPath_, uFieldFlagsStatic);
}
...
uObject* ScriptModule__RequireContext::Require(uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[35/*"require(): ...*/], uBox<int>(::TYPES[48/*int*/], uPtr(args)->Length())), ::STRINGS[36/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[53/*string*/]);

    if (::g::Uno::String::op_Equality(id, NULL))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[37/*"require(): ...*/]));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[39/*"JavaScript ...*/], path), ::STRINGS[40/*" was fixed!"*/]), this, ::STRINGS[30/*"/Users/ogne...*/], 1854, ::STRINGS[41/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[39/*"JavaScript ...*/], path), ::STRINGS[42/*" line "*/]), uBox<int>(::TYPES[48/*int*/], uPtr(e)->LineNumber())), ::STRINGS[43/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[30/*"/Users/ogne...*/], 1864, ::STRINGS[41/*"Require"*/], NULL);
...
{
    ScriptClass::_unoTypeToScriptClass_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[54/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/]));
}

static void ScriptClass_build(uType* type)
{
    ::TYPES[54] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), type, NULL);
    type->SetFields(0,
        ...
        ::TYPES[54/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/], (uintptr_t)&::g::Fuse::Scripting::ScriptClass::_unoTypeToScriptClass_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(5,
...
static void ScriptException_build(uType* type)
{
    ...
    type->SetFields(3,
        ...
        ::TYPES[48/*int*/], offsetof(::g::Fuse::Scripting::ScriptException, _LineNumber), 0,
    ...
    type->Reflection.SetFunctions(7,
        ...
        new uFunction("get_LineNumber", NULL, (void*)ScriptException__get_LineNumber_fn, 0, false, ::TYPES[48/*int*/], 0),
        new uFunction("get_Name", NULL, (void*)ScriptException__get_Name_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction(".ctor", NULL, (void*)ScriptException__New4_fn, 0, true, type, 6, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), ::TYPES[48/*int*/], ::g::Uno::String_typeof(), ::g::Uno::String_typeof()),
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    if (__this->LineNumber() >= 0)
    {
        ...
        stringBuilder->AppendLine(::g::Uno::Int::ToString(__this->LineNumber(), ::TYPES[48/*int*/]));
    }
...
static void ScriptMethod1_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Action_typeof();
    ::TYPES[55] = ScriptMethod1__CallClosure_typeof();
    type->SetPrecalc(
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[50/*"Cannot call...*/], __this, ::STRINGS[30/*"/Users/ogne...*/], 1582, ::STRINGS[51/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
static void ScriptModule_build(uType* type)
{
    ...
    ::TYPES[56] = ::g::Fuse::Scripting::IModuleProvider_typeof();
    ::TYPES[57] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[58] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[8] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[59] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[60] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[61] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[62] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[63] = ::g::Uno::UX::BundleFileSource_typeof();
    type->SetInterfaces(
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uArray* newlines = uArray::New(::TYPES[57/*char[]*/], offset);

    for (int i = 0; i < offset; ++i)
        uPtr(newlines)->Item<uChar>(i) = 10;

    ::g::Uno::Collections::List* args = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[58/*Uno.Collections.List<object>*/]);
...
{
    return uIs(obj, ::TYPES[56/*Fuse.Scripting.IModuleProvider*/]);
}
...
::g::Uno::IO::Bundle* ScriptModule::Bundle()
{
    ...
    ::g::Uno::UX::BundleFileSource* bfs = uAs< ::g::Uno::UX::BundleFileSource*>(File(), ::TYPES[63/*Uno.UX.BundleFileSource*/]);
...
uString* ScriptModule::GetSourcePath()
{
    ...
    if (::g::Uno::String::op_Inequality(FileName(), NULL))
        return ::g::Uno::String::Trim1(uPtr(::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(FileName())), '\\', '/')), uArray::Init<int>(::TYPES[57/*char[]*/], 1, '/'));
    else
        return ::STRINGS[11/*""*/];
}
...
::g::Uno::IO::BundleFile* ScriptModule::LookForFile(uString* path)
{
    ...
    if (Bundle() != NULL)
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(Bundle())->Files()), ::TYPES[59/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[60/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[61/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret4), ret4);

            if (ScriptModule::IsPathEqual(uPtr(f)->SourcePath(), path))
                return f;
        }

    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Uno::IO::Bundle::AllFiles()), ::TYPES[59/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[60/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::IO::BundleFile* f1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[61/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret5), ret5);
...
::g::Fuse::Scripting::Module* ScriptModule::TryResolve(uString* path, bool isFile)
{
    ...
    if (!isFile)
    {
        ...
        if (::g::Uno::UX::Resource::TryFindGlobal(path, uDelegate::New(::TYPES[62/*Uno.Predicate<object>*/], (void*)ScriptModule__Acceptor_fn, this), &res))
        {
            uObject* mp = (uObject*)res;
            return ::g::Fuse::Scripting::IModuleProvider::GetModule(uInterface(uPtr(mp), ::TYPES[56/*Fuse.Scripting.IModuleProvider*/]));
        }
    }
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    uArray* parts = ::g::Uno::String::Split(uPtr(moduleId), uArray::Init<int>(::TYPES[57/*char[]*/], 1, '/'));
...
static void Value_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction("ToNumber", NULL, (void*)Value__ToNumber_fn, 0, true, ::TYPES[51/*double*/], 1, uObject_typeof()));
}
...
double Value::ToNumber(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[50/*float*/]))
        return (double)uUnbox<float>(::TYPES[50/*float*/], obj);

    if (uIs(obj, ::TYPES[48/*int*/]))
        return (double)uUnbox<int>(::TYPES[48/*int*/], obj);

    if (uIs(obj, ::TYPES[64/*uint*/]))
        return (double)uUnbox<uint32_t>(::TYPES[64/*uint*/], obj);
