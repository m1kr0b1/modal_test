...
// /Users/ognen/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.47.7/rangecontrols/$.uno
// ---------------------------------------------------------------------------------------------------------------
...
static void CircularRangeBehavior_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/ognen/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.47.7/rangecontrols/$.uno");
...
void CircularRangeBehavior__OnRooted_fn(CircularRangeBehavior* __this)
{
    ...
    if ((__this->_rangeControl == NULL) && (__this->_binaryRangeControl == NULL))
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[2/*"RangeContro...*/], __this->Parent(), __this, ::STRINGS[3/*"/Users/ogne...*/], 137, ::STRINGS[4/*"OnRooted"*/]);
    else
    {
...
// /Users/ognen/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.47.7/$.uno
// --------------------------------------------------------------------------------------
...
// /Users/ognen/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.47.7/internal/$.uno
// -----------------------------------------------------------------------------------------------
...
void LinearRangeBehavior__OnRooted_fn(LinearRangeBehavior* __this)
{
    ...
    if (__this->Control == NULL)
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[6/*"RangeControl"*/], __this->Parent(), __this, ::STRINGS[3/*"/Users/ogne...*/], 418, ::STRINGS[4/*"OnRooted"*/]);
...
// /Users/ognen/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/0.47.7/$.uno
// -------------------------------------------------------------------------------------------------
...
static void ScrollableGoto_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/Users/ognen/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/0.47.7/$.uno");
...
{
    ctor_2();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[8/*"Use ScrollT...*/], this, ::STRINGS[9/*"/Users/ogne...*/], 112, ::STRINGS[10/*".ctor"*/]);
}
...
void Scroller::OnUpdated()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Invalid scr...*/], NULL, ::STRINGS[9/*"/Users/ogne...*/], 435, ::STRINGS[13/*"OnUpdated"*/]);
        return;
    }
...
void Scroller::UpdatePointerEvents(bool forceOff)
{
    ...
    {
        if (_gesture != NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"inconsisten...*/], NULL, ::STRINGS[9/*"/Users/ogne...*/], 218, ::STRINGS[15/*"UpdatePoint...*/]);
        else
    ...
    {
        if (_gesture == NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"inconsisten...*/], NULL, ::STRINGS[9/*"/Users/ogne...*/], 225, ::STRINGS[15/*"UpdatePoint...*/]);
        else
        {
            uPtr(_gesture)->Dispose();
            _gesture = NULL;
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[18] = uString::Const("/Users/ognen/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.47.7/$.uno");
    ::STRINGS[4] = uString::Const("OnRooted");
    ::TYPES[1] = ::g::Fuse::Elements::Element_typeof();
    type->SetInterfaces(
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[17/*"Element"*/], __this->Parent(), __this, ::STRINGS[18/*"/Users/ogne...*/], 1126, ::STRINGS[4/*"OnRooted"*/]);
        return;
    }
