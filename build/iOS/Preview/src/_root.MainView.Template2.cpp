...
// public partial sealed class MainView.Template2 :113
// {
// static Template2() :123
static void MainView__Template2__cctor__fn(uType* __type)
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Active"*/]);
}
...
static void MainView__Template2_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), offsetof(::g::MainView__Template2, nav_Active_inst), 0,
...
// public Template2(MainView parent, MainView parentInstance) :117
...
void MainView__Template2__New1_fn(MainView__Template2* __this, uObject** __retval)
{
    ...
    __this->nav_Active_inst = ::g::demoapp_FuseControlsNavigationControl_Active_Property::New1(uPtr(__this->__parent1)->nav, MainView__Template2::__selector0());
    ::g::Fuse::Triggers::Actions::Set* temp = (::g::Fuse::Triggers::Actions::Set*)::g::Fuse::Triggers::Actions::Set::New2(::TYPES[0/*Fuse.Triggers.Actions.Set<Fuse.Visual>*/], __this->nav_Active_inst);
    ::g::Fuse::Triggers::Actions::Set__set_Value_fn(temp, uPtr(__this->__parent1)->page2);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(__self1->Actions()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp);
    return *__retval = __self1, void();
}

// public Template2 New(MainView parent, MainView parentInstance) :117
...
// public Template2(MainView parent, MainView parentInstance) [instance] :117
...
// public Template2 New(MainView parent, MainView parentInstance) [static] :117
