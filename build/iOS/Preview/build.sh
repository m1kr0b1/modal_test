#!/bin/bash
# This file was generated based on '/Users/ognen/Library/Application Support/Fusetools/Packages/UnoCore/0.47.13/targets/ios/build.sh'.
...
##else
    xcodebuild -project "demo-app.xcodeproj" "$@" | tee >(checkForError)
##endif
